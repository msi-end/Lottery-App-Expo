    ...
    return (
        <View style={styles.main}>
            <View style={styles.head} >
                <Text style={styles.headTitle}> Top Lotteries</Text>
                <Pressable android_ripple={{color:COLORS.primary,borderless:true}}  onPress={() => { navigation.navigate("AllLottery")}} ><Ionicons name="grid" size={SIZES.large} color={COLORS.primary} /></Pressable>
            </View>
        </View>
    )
}
